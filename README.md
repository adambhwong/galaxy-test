...
- the k8s-deploy.yml included all required k8s manifests:
    1. deployment using the image built by the pipeline above from the GHCR
    ...
    4. using a Horizontal Pod Autoscaler (HPA) to control the pods count for cost opptimisation 
